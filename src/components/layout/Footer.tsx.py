        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center mb-4">
              ...
              <span className="font-serif font-bold text-xl">Dr. Aerospace</span>
            </Link>
            <p className="mb-6 text-gray-300 max-w-md">
              Expert in aerospace engineering and aerophysics with over 15 years of experience.
              Author of 3 books and numerous research papers on advanced fluid dynamics and 
            ...
            <div className="flex space-x-4">
              ...
              <a href="mailto:contact@example.com" aria-label="Email" className="text-gray-300 hover:text-space-accent transition-colors">
          ...
          <div>
            ...
            <address className="not-italic text-gray-300 space-y-2">
              <p>University of Aerospace</p>
              <p>1234 Flight Boulevard</p>
              <p>Aviation City, AC 10101</p>
              <p className="mt-4">
                <a href="mailto:contact@example.com" className="hover:text-space-accent transition-colors">
                  contact@example.com
                </a>
              </p>
              <p>
                <a href="tel:+1234567890" className="hover:text-space-accent transition-colors">
                  (123) 456-7890
                </a>
              </p>
            </address>
