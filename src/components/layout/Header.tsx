      ...
      <div className="container-custom">
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center">
            <Rocket
              className={`w-8 h-8 ${
                isScrolled ? 'text-space-dark' : 'text-space-accent'
              } mr-2`}
            />
            <span
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <NavLink
              to="/"
              className={({ isActive }) =>
                `${isScrolled ? 'text-gray-800' : 'text-white'} hover:text-space-accent transition-colors ${
      ...
      >
        <div className="flex flex-col items-center justify-center h-full space-y-8 text-center">
          <NavLink
            to="/"
            className={({ isActive }) =>
              `text-white text-2xl hover:text-space-accent transition-colors ${
                isActive ? 'font-semibold' : ''
              }`
            }
            onClick={closeMenu}
