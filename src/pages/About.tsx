          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div>
                ...
                <h2 className="text-space-dark mb-4">K M Jaishnav</h2>
                <p className="text-gray-700">Interested in Aerospace Engineering,Space Exploration </p>
              </div>
              
              <div className="space-y-4 text-gray-700">
                <p>
                  I've planned my career to advance the field of aerospace engineering through
                  cutting-edge research, innovative computational methods, and knowledge sharing.
                </p>
                <p>
                  After, I worked on research projects, focusing on Building of Space Colony, Space Exploration           and aerodynamic optimization.
                </p>
                <p>
                  My passion towards learning and exploring about space, where I've been mentored by several great teachers , who inspired and guided me  . My three books on  Building a Space Colony 'NERVIO', which has been given Honourable Mentions Award by the NSS (National Space Society). Then, on Quantum Mechanics, Metaphysics, Life, Consciousness, and Interstellar Mysteries , and so on.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li>Interested Aerospace Engineering, Astrophysics, the Origin of Universe</li>
                    <li>My greatest aim is to explore and discover something which gives enormous impact on development of all living beings.</li>
                    <li>Currently , studying in Senthil Public School</li>
                  </ul>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li>Invited to the the prestigious ISDC Conference 2023 held at Texas.</li>
                    <li>Proficient in Music Instruments (Keyboard and Guitar),Painting, Book and story writing, District Level Badminton PLayer</li>
                    <li>Given hourourable mentions award on my project 'NERVIO'.</li>
                  </ul>
                </div>
